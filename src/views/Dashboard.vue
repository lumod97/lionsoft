      ...
      <CCol :md="12">
        <CCard class="mb-4">
          <CCardBody>
            <CRow>
              <CCol :sm="5">
                <h4 id="traffic" class="card-title mb-0">Posibles ganancias</h4>
                <div class="small text-medium-emphasis">Desde Junio - 2023</div>
              </CCol>
          ...
          <CCardFooter>
            <CRow :xs="{ cols: 1 }" :md="{ cols: 5 }" class="text-center">
              <CCol class="mb-sm-2 mb-0">
                <div class="text-medium-emphasis">Ganancia actual</div>
                <strong>Ultimos 6 meses</strong>
                <CProgress
                  class="mt-2"
                  color="success"
                  thin
              ...
              <CCol class="mb-sm-2 mb-0 d-md-down-none">
                <div class="text-medium-emphasis">Ganancia esperada</div>
                <strong>Ultimos 6 meses</strong>
                <CProgress
                  class="mt-2"
                  color="info"
              ...
              <CCol class="mb-sm-2 mb-0">
                <div class="text-medium-emphasis">Nuevos usuarios</div>
                <strong>Ultimos 6 meses</strong>
                <CProgress
                  class="mt-2"
                  color="danger"
              ...
              <CCol class="mb-sm-2 mb-0 d-md-down-none">
                <div class="text-medium-emphasis">Conductores</div>
                <strong>Ultimos 6 meses</strong>
